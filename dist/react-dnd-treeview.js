...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object")
    ...
    exports["react-dnd-treeview"] = factory(
      require("react"),
      require("react-dnd"),
      require("immutable"),
      require("classnames")
    ...
    root["react-dnd-treeview"] = factory(
      root["React"],
      root["react-dnd"],
      root["Immutable"],
      root["classnames"]
  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
            ...
            _react2.default.createElement(
              "div",
              {
                style: Object.assign(
                  {},
                  props.insertBefore
                    ? _InsertTargetStyles.Styles.insertBeforeTarget
                    : _InsertTargetStyles.Styles.insertAfterTarget,
                  props.canDrop
                    ? _InsertTargetStyles.Styles.insertTargetCanDrop
                    : {},
                  props.isDropping
                    ? _InsertTargetStyles.Styles.insertTargetDropping
                    : {}
                )
              },
              _react2.default.createElement("div", {
                style: props.isDropping
                  ? _InsertTargetStyles.Styles.insertTargetMarkerDropping
                  : {}
              })
            )
          );
        ...
        var handleCanDrop = function handleCanDrop(props, monitor, item) {
          return (
            ...
            !item.allSourceIDs.contains(
              props.parentNode ? props.parentNode.id : null
            )
          );
        };
        ...
        var collectNodeDropProps = function collectNodeDropProps(
          connect,
          monitor
        ) {
          return {
        ...
        var DroppableTreeViewInsertTarget = (exports.DroppableTreeViewInsertTarget = (0,
        _reactDnd.DropTarget)(
          [_DraggedNode.TYPE],
          nodeTarget,
      ...
      /***/ function(module, exports) {
        ...
        (function(Styles) {
          Styles.insertBeforeTarget = Object.assign(
            {},
            NormalStyles.insertTarget,
            NormalStyles.insertBeforeTarget,
          ...
          Styles.insertAfterTarget = Object.assign(
            {},
            NormalStyles.insertTarget,
            NormalStyles.insertAfterTarget,
            isDebug ? DebugStyles.insertTarget : {},
          ...
          Styles.insertTargetCanDrop = Object.assign(
            {},
            NormalStyles.insertTargetCanDrop,
            isDebug ? DebugStyles.insertTargetCanDrop : {}
          );
          Styles.insertTargetDropping = Object.assign(
            {},
            NormalStyles.insertTargetDropping,
            isDebug ? DebugStyles.insertTargetDropping : {}
          );
          Styles.insertTargetMarkerDropping =
            NormalStyles.insertTargetMarkerDropping;
      ...
      /***/ function(module, exports, __webpack_require__) {
            ...
            _react2.default.createElement(
              "div",
              {
                className: (0, _classnames3.default)(
                  "node",
                  _defineProperty({}, "nodeDragging", props.isDragging)
                ),
                key: props.node.id
              },
              ...
              props.node.isCollapsed
                ...
                : _react2.default.createElement(
                    "div",
                    { className: "nodeChildren" }, // edited code
                    // { className: props.classNames.nodeChildren },   // original code
                    props.node.children && !props.node.children.items.isEmpty()
                      ? _react2.default.createElement(TreeViewItemList, {
                      ...
                      : _react2.default.createElement(
                          _InsertTarget.DroppableTreeViewInsertTarget,
                          {
                            insertBefore: false,
                            parentNode: props.node,
                            parentChildIndex: 0,
        ...
        var gatherNodeIDs = function gatherNodeIDs(node) {
          return _immutable2.default.Set.of(node.id)
            .union(
              node.children
                ? node.children.items.flatMap(gatherNodeIDs)
                : _immutable2.default.List()
            )
            .toSet();
        };
        var nodeSource = {
        ...
        var collectNodeDragProps = function collectNodeDragProps(
          connect,
          monitor
        ) {
          return {
        ...
        var DraggableTreeViewItem = (exports.DraggableTreeViewItem = (0,
        _reactDnd.DragSource)(
          _DraggedNode.TYPE,
          nodeSource,
        ...
        //   z-index: 2;
        // }
        var TreeViewItemList = (exports.TreeViewItemList = function TreeViewItemList(
          props
        ) {
          return _react2.default.createElement(
            "div",
